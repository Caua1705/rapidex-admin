...
export const PAPEL_POR_ROTA = {
  ...
  '/admin/branches/{branch_id}/courier-fee': { GET: 'GERENCIA', PATCH: 'SOMENTE_DONO' },
  ...
  '/admin/couriers': { GET: 'PESSOAS', POST: 'GERENCIA' },
  '/admin/couriers/{courier_id}': { DELETE: 'GERENCIA', GET: 'PESSOAS', PATCH: 'GERENCIA' },
  '/admin/couriers/{courier_id}/access': { POST: 'GERENCIA' },
  '/admin/couriers/{courier_id}/assignments': { GET: 'PESSOAS', POST: 'PESSOAS' },
  ...
  '/admin/orders/{order_id}/courier': { DELETE: 'PESSOAS', GET: 'PESSOAS' },
  ...
  '/admin/reports/couriers': { GET: 'GERENCIA' },
